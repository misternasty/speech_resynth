...
tar zxf ${dataset_root}/train_clean_100.tar.gz -C ${dataset_root}
tar zxf ${dataset_root}/train_clean_360.tar.gz -C ${dataset_root}
tar zxf ${dataset_root}/train_other_500.tar.gz -C ${dataset_root}
tar zxf ${dataset_root}/dev_clean.tar.gz -C ${dataset_root}
tar zxf ${dataset_root}/dev_other.tar.gz -C ${dataset_root}
tar zxf ${dataset_root}/test_clean.tar.gz -C ${dataset_root}
tar zxf ${dataset_root}/test_other.tar.gz -C ${dataset_root}